...
def update_test_requirements(old_bokeh_version, new_bokeh_version, old_version, new_version):
...
if __name__ == "__main__":
    ...
    if old_version_semver.major != new_bokeh_version_semver.major or old_version_semver.minor != new_bokeh_version_semver.minor:
        new_version = f"{new_bokeh_version_semver.major}.{new_bokeh_version_semver.minor}.0"
    ...
    update_test_requirements(old_bokeh_version, new_bokeh_version, old_version, new_version)
