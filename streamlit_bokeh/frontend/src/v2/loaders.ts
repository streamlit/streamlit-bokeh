...
const BOKEH_URLS = {
  core: resolveAssetUrl(`${BOKEH_PUBLIC}bokeh-3.9.2.min.js`),
  widgets: resolveAssetUrl(`${BOKEH_PUBLIC}bokeh-widgets-3.9.2.min.js`),
  tables: resolveAssetUrl(`${BOKEH_PUBLIC}bokeh-tables-3.9.2.min.js`),
  api: resolveAssetUrl(`${BOKEH_PUBLIC}bokeh-api-3.9.2.min.js`),
  gl: resolveAssetUrl(`${BOKEH_PUBLIC}bokeh-gl-3.9.2.min.js`),
  mathjax: resolveAssetUrl(`${BOKEH_PUBLIC}bokeh-mathjax-3.9.2.min.js`),
}
